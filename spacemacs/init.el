...
This function should only modify configuration layer settings."
  ...
  (when (file-exists-p "~/OneDrive/confiles/common/emacs/layers")
    (add-to-list 'dotspacemacs-configuration-layer-path "~/OneDrive/confiles/common/emacs/layers" t)
...
`dotspacemacs/user-config' first."
  ...
  (when (eq system-type 'gnu/linux)
    (setq shared-dir (expand-file-name "~/OneDrive/emacs-bookmarks/cache/undo"))
    (setq-default
  ...
  (setq eshell-aliases-file (expand-file-name "~/OneDrive/dotfiles/spacemacs/eshell/alias"))
  )
...
(if (file-exists-p custom-file)
    (load custom-file))
(load "~/OneDrive/dotfiles/spacemacs/funcs.el")
