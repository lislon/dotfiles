...
(define-key projectile-command-map (kbd "s s") 'helm-projectile-pt)

;; Add new command to personal configg
(global-set-key (kbd "<f12>") (lambda () (interactive)(find-file "~/.emacs.d/personal/custom.el")
                                (end-of-buffer)
                                (previous-line 7)))

;;;; No Rang section starts
...
;; to make sql-mysql work on Windows properly
(if (eq system-type 'windows-nt)
    (setq sql-mysql-options '("-C" "-t" "-f" "-n"))
    )

;; (load-file "~/.emacs.d/personal/sql-completion.el")
...
;;;; google-translate C-c w g
(setq google-translate-default-source-language "en")
(setq google-translate-default-target-language "ru")
(define-key prelude-mode-map "\C-cwg" 'google-translate-at-point)
